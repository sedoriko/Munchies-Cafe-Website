...
import { ShoppingCart, Clock, LogOut, Receipt, Menu } from 'lucide-react';
...
export default function StaffLayout() {
  ...
  const navItems = [
    ...
    { path: '/staff/orders', icon: Receipt, label: 'Orders' },
      ...
      <div className="p-6 border-b border-amber-800">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-sm text-amber-300 font-medium">Staff Dashboard</p>
          </div>
        </div>
      </div>
